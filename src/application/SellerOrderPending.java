...
public class SellerOrderPending implements Initializable {
    ...
    void noAction(ActionEvent event) {
    	...
    	alert.setHeaderText("");
    	alert.setContentText("Are you sure you don't want to accept this order?");
    ...
    void yesAction(ActionEvent event) {
    	...
    	UserDB.updateOrder("Ongoing", SellerOrders.orderNo);
